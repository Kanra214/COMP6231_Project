...
public class UdpRequest extends Thread {
     ...
     */
    public UdpRequest(CenterServerInfo serverInfo, UdpRequestType requestType, String replicaName) throws IOException {
    ...
    public UdpRequest(CenterServerInfo serverInfo, UdpRequestType requestType, RecordBase record, String replicaName) throws IOException {
        this.serverInfo = serverInfo;
        this.requestType = requestType;
        this.record = record;
        this.replicaName = replicaName;
