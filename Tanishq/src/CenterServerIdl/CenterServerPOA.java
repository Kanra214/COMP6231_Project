 ...
 implements CenterServerIdl.CenterServerOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // CenterServerIdl/CenterServer/addEvent
       {
       ...
       case 1:  // CenterServerIdl/CenterServer/removeEvent
       {
         String eventID = in.read_string ();
         String eventType = in.read_string ();
         String $result = null;
       ...
       case 2:  // CenterServerIdl/CenterServer/listEventAvailability
       {
         String eventType = in.read_string ();
         String $result = null;
       ...
       case 3:  // CenterServerIdl/CenterServer/bookEvent
       {
       ...
       case 4:  // CenterServerIdl/CenterServer/getBookingSchedule
       {
         String customerID = in.read_string ();
         String $result = null;
       ...
       case 5:  // CenterServerIdl/CenterServer/cancelEvent
       {
         String customerID = in.read_string ();
         String eventID = in.read_string ();
         String $result = null;
       ...
       case 6:  // CenterServerIdl/CenterServer/swapEvent
       {
         String customerID = in.read_string ();
